...
import { faHeart, faCalendarAlt, faMapMarkerAlt } from '@fortawesome/free-regular-svg-icons'
...
export default function Home() {
  ...
  return (
    <div className='bg-white border my-2 mx-4 px-4 rounded-xl shadow-md shadow-blue-500/30'>
      ...
      <MenuCategorias />
{/*       <PetList pets={mascotas}/>
 */}      
      <section className="grid sm:grid-cols-1 md:grid-cols2 lg:grid-cols-2 xl:grid-cols-3 gap-4 mt-2">
        <div className="flex flex-col cursor-pointer relative border w-full h-68 rounded-lg shadow-lg">
          <header className="relative h-4/5">
            <img src="/dog.avif" alt="perro" className="w-full h-full object-cover rounded-t-lg" />
            ...
            <h1
              className="absolute bottom-2 right-2 text-white text-lg font-semibold text-4xl z-10"
          ...
          <footer className="flex flex-col h-1/4 bg-[#ffe9c2] text-black py-4 items-center justify-center w-full relative overflow-hidden font-montserrat font-semibold">
            <div className="flex items-center space-x-2 z-10">
              <p>7 años</p>
            </div>
            <div className="flex items-center space-x-2 z-10">
              <FontAwesomeIcon icon={faMapMarkerAlt} />
              <p className='text-gray-500 text-sm font-light'>Tegucigalpa, HN</p>
            </div>
            ...
            >
              ...
              <path d="M23.0099 104.61C9.26048 120.154 -18.9528 113.399 -29.4054 97.3449C-39.858 81.2904 -34.2644 53.0729 -14.8423 46.4718C7.13988 40.5404 27.1205 37.6826 37.5731 53.7371C48.0257 69.7915 39.4475 86.0272 23.0099 104.61Z" fill="#FFD68F" />
            </svg>
          </footer>
        </div>
        <div className="flex flex-col cursor-pointer relative border w-full h-68 rounded-lg shadow-lg">
          ...
          <footer className="flex rounded-b-4 flex-col h-1/4 bg-[#ffe9c2] text-black py-4 items-center justify-center w-full relative overflow-hidden font-montserrat font-semibold">
            <div className="flex items-center space-x-2 z-10">
              <p>7 años</p>
            </div>
            <div className="flex items-center space-x-2 z-10">
