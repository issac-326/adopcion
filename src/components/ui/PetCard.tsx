...
const PetCard= ({
  ...
  return (
<div className="flex flex-col cursor-pointer hover:scale-105 transition-transform duration-300 relative border w-full h-68 rounded-lg shadow-lg" key={id} onClick={() => { router.push(`/mascotas/${id}`) }} >
  <header className="relative h-4/5">
    {/* La imagen no excederá el tamaño del contenedor */}
    <Image 
      src={imagen} 
      alt="perro" 
      ...
      width={50} 
      height={50}
      style={{ maxHeight: '100%', maxWidth: '100%', objectFit: 'cover' }} // Restricción adicional
    />
  ...
  <footer
  className="flex flex-col h-1/4 text-black py-4 items-center justify-center w-full relative overflow-hidden font-montserrat font-semibold"
