          ...
          <div className="flex-1 flex flex-col justify-between p-8">
            ...
            <div className="flex-1 p-8 pt-2 flex flex-col">
              ...
              {!isMyPet && mascota.estado_adopcion && (
                <div>
                  <button
                    className="w-full sm:w-full lg:w-3/5 py-2 sm:py-3 bg-orange-300 text-white rounded-3xl text-sm sm:text-lg transition-colors mx-auto block mt-5"
              ...
              {isMyPet && mascota.estado_adopcion && mascota.confirmacion != 3 && mascota.confirmacion !=2 && (<div className='flex flex-col sm:flex-row justify-around items-center gap-4 py-4'>
                <div
