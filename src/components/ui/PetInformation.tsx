  ...
  return (
    <div className="bg-white min-h-screen flex flex-col lg:flex-row-reverse p-5">
      ...
      <div className="flex-1 flex flex-col justify-between p-8">
        {/* Botón para regresar */}
        <div 
          className="rounded-full w-10 h-10 lg:w-12 lg:h-12 flex items-center justify-center cursor-pointer hover:scale-110"
          onClick={() => isInicio ? router.push('/menu/inicio') : router.push('/menu/perfil')}
        >
