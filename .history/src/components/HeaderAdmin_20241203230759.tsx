  ...
  <nav className="flex flex-col gap-2 p-2 sm:p-4">
    {menuItems.map((item, index) => (
      <Button
        ...
        key={index}
        variant="ghost"
        className={`w-full justify-start hover:bg-[#fe8a5b]/30 transition-transform duration-300 text-medium break-words ${selectedIndex === index ? 'bg-[#fe8a5b] text-white hover:bg-[#fe8a5b]' : ''}`}
      >
        {item.icon}
